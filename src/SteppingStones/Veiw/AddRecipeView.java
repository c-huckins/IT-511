...
public class AddRecipeView extends JFrame {
    ...
    public AddRecipeView(RecipeBox recipeController) throws HeadlessException {
        ...
        // Place the name field and label.
        ...
        // Place the servings field and label.
        ...
        // Place the label that show the current calories based on the ingredients added so far.
        ...
        // Place the calorie override field and label
        ...
        // Place the scroll list for the ingredients added to the recipe.
        ...
        // Place the ingredient name field.
        ...
        // Place the ingredient amount field and type combo box.
        ...
        // Place the calories and type combo box.
        ...
        // Button used to finalize and add the ingreient to the recipe.
        ...
        addIngredientButton.addActionListener((ActionEvent e) -> {
            handleAddIngredientButtonClick();
        });
        add(addIngredientButton);
        
        // Button used to save the changes made to an ingredient.
        ...
        // Button used to not save the changes made to an ingreient.
    ...
    /**
     * Sets the view that created this view.
     * 
     * @param callingView 
     */
    ...
    /**
     * Verifies the provided data and returns a new recipe.
     * Displays and error message and returns null if the information is not valid. 
     * 
     * @return 
     */
    ...
    /**
     * Builds an ingredient object from the provided data.
     * Returns null and shows an error if the data is not valid.
     * 
     * @return 
     */
    ...
    /**
     * Clears the fields for a new ingredient entry.
     */
    ...
    private void handleAddIngredientButtonClick() {
